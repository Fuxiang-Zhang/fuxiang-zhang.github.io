...
Short name: Large Language Models

Reasoning, self-verification, and preference alignment in language models. Explore work on how models learn and how their responses can be adapted.

### Reinforcement Learning {#rl}
Short name: Reinforcement Learning

Learning from data, prior knowledge, and interaction. Explore publications on offline reinforcement learning, policy generalization, and model-based learning.

### Multi-Agent Reinforcement Learning {#marl}
Short name: Multi-Agent RL

Learning and coordination across multiple agents. Explore work on communication, transferable skills, and multi-agent language-model systems.
...
### SkyReels-V4: Multi-modal Video-Audio Generation, Inpainting and Editing Model {#skyreels-v4}
...
### Dr. MAS: Stable Reinforcement Learning for Multi-Agent LLM Systems {#dr-mas}
...
### DeRL-SWE: Decoupled Reinforcement Learning with Nested Credit Assignment for Software Engineering {#derl-swe}
...
### Skywork Open Reasoner 1 Technical Report {#skywork-or1}
...
### Skywork-Reward-V2: Scaling Preference Data Curation via Human-AI Synergy {#skywork-reward-v2}
...
### Incentivizing LLMs to Self-Verify Their Answers {#self-verification}
...
### Multi-Agent Imitation by Learning and Sampling from Factorized Soft Q-Function {#multi-agent-imitation}
...
### Q-Adapter: Customizing Pre-trained LLMs to New Preferences with Forgetting Mitigation {#q-adapter}
...
### Disentangling Policy from Offline Task Representation Learning via Adversarial Data Augmentation {#offline-task-representation}
...
### Policy Rehearsing: Training Generalizable Policies for Reinforcement Learning {#policy-rehearsing}
...
### Internal Logical Induction for Pixel-Symbolic Reinforcement Learning {#logical-induction}
...
### Policy Regularization with Dataset Constraint for Offline Reinforcement Learning {#dataset-constraint}
...
### Discovering Generalizable Multi-agent Coordination Skills from Multi-task Offline Data {#coordination-skills}
...
### Multi-Agent Concentrative Coordination with Decentralized Task Representation {#concentrative-coordination}
...
### Towards Deployment-Efficient and Collision-Free Multi-Agent Path Finding (Student Abstract) {#multi-agent-path-finding}
...
### Multi-Agent Incentive Communication via Decentralized Teammate Modeling {#incentive-communication}
...
### Improving Sample Efficiency of Reinforcement Learning with Background Knowledge from Large Language Models {#llm-background-knowledge}
...
### Generalizable Multi-Modal Adversarial Imitation Learning for Non-Stationary Dynamics {#multi-modal-imitation}
...
### Multiagent Continual Coordination via Progressive Task Contextualization {#continual-coordination}
...
### Model Gradient: Unified Model and Policy Learning in Model-based Reinforcement Learning {#model-gradient}
...
Links: [Skywork AI](https://skywork.ai)
...
#### Related publication · TNNLS 2025
...
### Nanjing University
Degree: Master’s degree · School of Artificial Intelligence
...
Issuer: Nanjing University, bachelor’s (2021) and master’s (2024)
Period: 2021 · 2024

### Gold Award · Algorithm Design Competition
Issuer: 16th Algorithm Design Competition, Nanjing University
Period: 2020

### Second Prize · CUMCM
Issuer: China Undergraduate Mathematical Contest in Modeling
Period: 2019
