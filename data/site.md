...
Home: bio
Title: Fuxiang Zhang - Homepage
Description: Explore Fuxiang Zhang’s research in large language models, reinforcement learning, and multi-agent systems. Publications, background, and a conversational research assistant.
Position: Ph.D. student · NTU · Singapore
Email: zfx.agi@gmail.com
Links: [GitHub](https://github.com/mansicer), [Google Scholar](https://scholar.google.com/citations?user=GZRrWXAAAAAJ), [LinkedIn](https://www.linkedin.com/in/fuxiang-zhang-2b7bb418a/), [X (Twitter)](https://x.com/fuxiang_z)
...
I am a Ph.D. student at [Nanyang Technological University](https://www.ntu.edu.sg/), advised by Prof. [Bo An](https://personal.ntu.edu.sg/boan). I received my bachelor’s and master’s degrees from Nanjing University, where I worked with Prof. [Yang Yu](https://www.lamda.nju.edu.cn/yangyu/) and Prof. [Zongzhang Zhang](https://www.lamda.nju.edu.cn/zhangzz/) in the [LAMDA](http://www.lamda.nju.edu.cn/MainPage.ashx) group.

My research focuses on **reinforcement learning for reasoning and agentic LLMs**, spanning post-training, test-time preference alignment, and multi-agent learning. More broadly, I am interested in improving the sample efficiency and generalization of reinforcement learning agents.

[Explore my research](#research), type [/help](#help), or ask a question below.
...
My research explores how reinforcement learning and test-time inference can improve the reasoning, decision-making, and preference alignment of large language models.

<details>
<summary><h4>Reinforcement learning for reasoning and agents</h4></summary>

I develop reinforcement learning methods for **mathematical reasoning and agentic problem solving**, with a focus on self-verification, credit assignment for software engineering, and stable multi-agent training.

:::paper{ref="skywork-or1"}
Mitigating premature entropy collapse during RL training to improve mathematical and coding performance.
:::

:::paper{ref="derl-swe"}
Training repair first, then rewarding code localization by the success of subsequent repairs to learn the full pipeline.
:::

:::paper{ref="self-verification"}
Jointly training answer generation and verification with RL, enabling test-time scaling without an external verifier.
:::

:::paper{ref="dr-mas"}
Normalizing advantages with each agent’s own reward statistics to reduce gradient instability during joint training.
:::
</details>

<details>
<summary><h4>Preference alignment and reward modeling</h4></summary>

I study how reward modeling, post-training, and test-time inference can **adapt language models to diverse user preferences** while preserving their existing capabilities.

:::paper{ref="q-adapter"}
Learning a residual Q-function from preference pairs to adapt a pretrained model while mitigating forgetting of its original capabilities.
:::

:::paper{ref="skywork-reward-v2"}
Using verified human annotations to guide automated preference data curation, improving reward quality beyond gains from data scale alone.
:::

:::paper{ref="rear"}
Separating question and preference rewards to steer sampling and search toward user preferences without retraining.
:::
</details>

### Reinforcement Learning and Multi-agent Systems

My broader research in reinforcement learning focuses on cooperation, generalization, and sample efficiency.

<details>
<summary><h4>Multi-agent cooperation</h4></summary>

I study how agents can **learn to coordinate through imitation, communication, and transferable skills** across cooperative tasks.

:::paper{ref="multi-agent-imitation"}
Learning from demonstrations with value decomposition and direct action sampling, avoiding adversarial policy optimization in discrete and continuous control.
:::

:::paper{ref="incentive-communication"}
Predicting teammates’ actions to generate targeted messages that directly adjust their action values.
:::

:::paper{ref="coordination-skills"}
Extracting task-invariant skills from offline demonstrations, then learning to combine them for coordination on unseen tasks.
:::

:::paper{ref="concentrative-coordination"}
Using local observations to represent subtasks and attend to relevant ones, allowing agents to form implicit coordination groups.
:::

:::paper{ref="continual-coordination"}
Sharing feature representations while progressively adding task-specific policy heads, with each agent selecting the relevant head locally.
:::
</details>

<details>
<summary><h4>Generalization and offline learning</h4></summary>

I investigate how agents can **learn from limited offline data and generalize** across tasks and changing environment dynamics.

:::paper{ref="multi-modal-imitation"}
Combining demonstration transitions across multiple time steps with a history encoder to handle mismatched and suddenly changing dynamics.
:::

:::paper{ref="offline-task-representation"}
Generating adversarial data to prevent task representations from relying on spurious correlations with the data-collecting policy.
:::

:::paper{ref="dataset-constraint"}
Constraining policies toward nearby state–action examples while allowing actions absent from the dataset at the current state.
:::

:::paper{ref="policy-rehearsing"}
Rehearsing across a diverse set of generated dynamics models to prepare policies for unfamiliar environments with limited interaction data.
:::
</details>

<details>
<summary><h4>Sample-efficient reinforcement learning</h4></summary>

I explore how knowledge from language models, logical induction, and learned environment models can **reduce the interactions needed** to train effective reinforcement learning agents.

:::paper{ref="llm-background-knowledge"}
Extracting reusable environment knowledge from a few experiences and converting it into reward shaping that preserves task-optimal policies.
:::

:::paper{ref="logical-induction"}
Inducing logical rules from symbolic observations and using them as intrinsic rewards to guide learning from pixels.
:::

:::paper{ref="model-gradient"}
Training dynamics models to match policy gradients from real experience, aligning model learning with the goal of improving the policy.
:::
</details>
...
All of my publications, ordered by year from newest to oldest. Click a title for details.
...
Venue short: ICLR MALGAI Workshop
Year: 2026
...
:::publication
Title: DeRL-SWE: Decoupled Reinforcement Learning with Nested Credit Assignment for Software Engineering
Id: derl-swe
...
Venue short: ICML DL4C Workshop
Year: 2026
Topic: Large Language Models
...
Venue short: AAAI Student Abstract
Year: 2023
Topic: Multi-Agent RL
